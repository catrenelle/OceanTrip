...
{
	public partial class FormCurrentRoute : BaseForm
	{
		...
		private void BindRouteIcons()
		{
			...
			//r1n1.DataBindings.Add("Image", databinds, "r1n1_icon", true, DataSourceUpdateMode.OnPropertyChanged);
		...
		private void BindRouteNames()
		{
			...
			//r1l1.DataBindings.Add("Text", databinds, "r1n1_name", true, DataSourceUpdateMode.OnPropertyChanged);
